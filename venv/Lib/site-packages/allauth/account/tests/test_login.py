...
@override_settings(
    ...
    ACCOUNT_SIGNUP_REDIRECT_URL="/sign/welcome/",
...
class LoginTests(TestCase):
    ...
    def test_redirect_when_authenticated(self):
        ...
        self.assertRedirects(resp, "/sign/profile/", fetch_redirect_response=False)
    ...
    def test_login_failed_attempts_exceeded_cleared_on_password_reset(self):
        ...
        url = body[body.find("/sign/password/reset/") :].split()[0]
    ...
    def test_login_inactive_account(self):
        """
        Tests login behavior with inactive sign.

        Inactive user sign should be prevented from performing any actions,
...
def test_login_password_forgotten_link_present(client, db):
    ...
    assert (
        ...
        == '<a href="/sign/password/reset/">Forgot your password?</a>'
    )
