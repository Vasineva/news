...
def get_social_accounts(user):
    """
    {% get_social_accounts user as sign %}

    Then:
        {{sign.twitter}} -- a list of connected Twitter sign
        {{sign.twitter.0}} -- the first Twitter account
        {% if sign %} -- if there is at least one social account
    """
    accounts = {}
